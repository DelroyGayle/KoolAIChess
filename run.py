...
def handle_input_from_file_for_player(chess, from_file, from_rank, to_file, to_rank,
                                attacking_piece_letter, taken):
    """
...
def player_move_validation_loop(chess, from_file, from_rank, to_file, to_rank,
    ...
    while True:
        ...
        # If so, fetch the next move from there
        do_next = handle_input_from_file_for_player(chess, from_file, from_rank, to_file, to_rank)
        if do_next == "return":
            return
